...
import TransactionsHeader from "../components/legacy/TransactionsHeader";
import TransactionItem from "../components/legacy/TransactionItem";
import TransactionFilterModal from "../components/legacy/TransactionFilterModal";
import ActiveFilters from "../components/legacy/ActiveFilters";
      ...
      <View style={styles.content}>
        ...
        {hasActiveFilters() && (
          <ActiveFilters
            filters={filters}
            onClearFilter={(key) => {
              if (key === "type") handleTypeChange("all");
              if (key === "category") handleCategoryChange("all");
              if (key === "dateRange") handleDateRangeChange(null);
            }}
